...
export default function AcessoBloqueadoPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg max-w-md w-full p-8 text-center">
        ...
        <button
          onClick={logout}
          className="w-full bg-slate-800 dark:bg-slate-700 text-white rounded-xl py-2.5 text-sm font-semibold hover:bg-slate-700 dark:hover:bg-slate-600 transition-colors"
        >
          Sair
        </button>
      </div>
